    ...
    <Sidebar collapsible="icon" variant="floating" className="p-2 border-r border-slate-100 bg-white">
      <SidebarHeader className="p-2">
        <div className="rounded-2xl border border-slate-100 bg-white p-3 shadow-sm">
          ...
          {!collapsed && (
            <div className="mt-3 flex items-center gap-2 rounded-xl bg-violet-50 px-2.5 py-2 text-xs font-medium text-violet-700">
      ...
      <SidebarFooter className="p-2 gap-2">
        {!collapsed && (
          <div className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-white p-3 shadow-sm">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-violet-600 text-white font-bold text-sm">
